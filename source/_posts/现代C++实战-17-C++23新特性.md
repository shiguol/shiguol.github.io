...
> 这是「现代 C++ 实战」系列的第 17 篇。建议先读 [第 16 篇：GoogleTest](/2026/07/17/现代C++实战-16-GoogleTest单元测试/) 与 [第 08 篇：错误处理](/2026/07/09/现代C++实战-08-错误处理策略/)。
...
与 [第 08 篇](/2026/07/09/现代C++实战-08-错误处理策略/) 对照：`expected` 适合**可预期的失败**（解析、文件打开）；异常仍适合**真正异常路径**。
...
基于 **std::format**（[第 09 篇](/2026/07/10/现代C++实战-09-C++20格式化与编译期计算/)），类型安全、可本地化。头文件 `<print>`，GCC 14+ / Clang 18+ 库支持较新。
...
| **Ranges** | `views::zip`、`enumerate`、`chunk`、`slide`…（详见 [第 10 篇](/2026/07/11/现代C++实战-10-Ranges与函数式风格/)） |
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 16 | [GoogleTest 单元测试](/2026/07/17/现代C++实战-16-GoogleTest单元测试/) | ✅ |
| **17** | **C++23 新特性（本篇）** | ✅ |
