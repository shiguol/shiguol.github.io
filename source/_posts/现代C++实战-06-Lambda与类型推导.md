...
> 这是「现代 C++ 实战」系列的第 6 篇。对应 demo：`ref/cpp_demo/basics/lambda_demo/`。建议先读 [第 05 篇：智能指针（下）](/2026/07/06/现代C++实战-05-智能指针下-模式与循环引用/)。
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 05 | [智能指针（下）](/2026/07/06/现代C++实战-05-智能指针下-模式与循环引用/) | ✅ |
| **06** | **Lambda 与类型推导（本篇）** | ✅ |
| 07 | C++17 工具箱 | 下一篇 |
