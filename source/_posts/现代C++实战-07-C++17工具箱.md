---
cover: /images/cover/cpp/cpp17-toolbox.png
...
> 这是「现代 C++ 实战」系列的第 7 篇。建议先读 [第 06 篇：Lambda 与类型推导](/2026/07/07/现代C++实战-06-Lambda与类型推导/)。
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 06 | [Lambda 与类型推导](/2026/07/07/现代C++实战-06-Lambda与类型推导/) | ✅ |
| **07** | **C++17 工具箱（本篇）** | ✅ |
| 08 | 错误处理策略 | 下一篇 |
