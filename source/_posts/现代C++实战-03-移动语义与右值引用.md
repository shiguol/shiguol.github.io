...
> 这是「现代 C++ 实战」系列的第 3 篇。对应 demo：`ref/cpp_demo/basics/right_ref_demo/`。建议先读 [第 02 篇：C++ 版本演进一览](/2026/07/03/现代C++实战-02-C++版本演进一览/)。
...
首次编译需 C++11 及以上（建议 C++17，与系列 Docker 环境一致）。若链接报错，回到 [第 00 篇环境搭建](/2026/07/01/现代C++实战-00-环境搭建与项目导览/) 检查编译器版本。
...
| 02 | [C++ 版本演进一览](/2026/07/03/现代C++实战-02-C++版本演进一览/) | ✅ |
| **03** | **移动语义与右值引用（本篇）** | ✅ |
