...
> 这是「现代 C++ 实战」系列的第 4 篇。对应 demo：`ref/cpp_demo/smart_pointers/` 第 01–04 节。建议先读 [第 03 篇：移动语义与右值引用](/2026/07/04/现代C++实战-03-移动语义与右值引用/)。
...
| **大小** | 通常与原始指针相同（无额外控制块） |
| **拷贝** | 禁止 |
| **移动** | 允许，配合 [第 03 篇](/2026/07/04/现代C++实战-03-移动语义与右值引用/) 的移动语义 |
| **默认删除** | `delete`；可自定义删除器 |
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 03 | [移动语义与右值引用](/2026/07/04/现代C++实战-03-移动语义与右值引用/) | ✅ |
