...
> 这是「大模型数学速成」系列的第 1 篇。建议先读 [第 00 篇：读 Transformer 前需要哪些数学？](/2026/07/04/大模型数学速成（00）：读-Transformer-前需要哪些数学？/)。下一篇我们讲 **矩阵乘法**——神经网络的「基本变换器」。
...
> **读公式前先确认约定。** 论文、框架文档、推理引擎源码可能用不同顺序。本系列**一律采用 `[特征维, token 数]`**，与 [第 00 篇](/2026/07/04/大模型数学速成（00）：读-Transformer-前需要哪些数学？/) 的符号表一致。
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 00 | [读 Transformer 前需要哪些数学？](/2026/07/04/大模型数学速成（00）：读-Transformer-前需要哪些数学？/) | ✅ |
