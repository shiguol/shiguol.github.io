...
> 这是「现代 C++ 实战」系列的第 1 篇。对应 demo：`ref/cpp_demo/projects/fetch_content/`。建议先读 [第 00 篇：环境搭建与项目导览](/2026/07/01/现代C++实战-00-环境搭建与项目导览/)。
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 00 | [环境搭建与项目导览](/2026/07/01/现代C++实战-00-环境搭建与项目导览/) | ✅ |
| **01** | **CMake 与现代构建（本篇）** | ✅ |
| 02 | C++ 版本演进一览 | 下一篇 |
| 03 | 移动语义与右值引用 | 待写 |
