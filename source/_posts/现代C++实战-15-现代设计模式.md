...
> 这是「现代 C++ 实战」系列的第 15 篇。建议先读 [第 14 篇：线程池与背压控制](/2026/07/15/现代C++实战-14-线程池与背压控制/)。
...
C++23 有 `std::scope_exit`；之前可用 small helper 或第三方 `scope_guard`。与 [第 04 篇](/2026/07/05/现代C++实战-04-智能指针上-所有权与RAII/) 的智能指针、`lock_guard` 一脉相承。
...
| 篇号 | 标题 | 状态 |
|------|------|------|
| 14 | [线程池与背压控制](/2026/07/15/现代C++实战-14-线程池与背压控制/) | ✅ |
| **15** | **现代设计模式（本篇）** | ✅ |
